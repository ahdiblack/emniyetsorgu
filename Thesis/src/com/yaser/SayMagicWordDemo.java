	...
	private void hookButtons() {
		...
		speak.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO acquireGuess metodundan once, menu için tts kullanýlmalý
				// menuden sonra ise kullanýcýnýn inputu beklenir vs. dongu gibi
				// gider bu
				acquireGuess();
			}
		});
...
//		 json.execute();
		...
		// //TODO burada menu soylendikten sonra kullanýcýnýn soyledikleri
		// //karsýlastýrýlýp menu olup olmadýgý kontrol edilecek
		// if (mostLikelyThingHeard.equals(magicWord))
		// {
		// message =
		// "Doðru: Sihirli kelimeyi bildiniz " + mostLikelyThingHeard;
		// }
		// else
		// {
		// message = "Yanlýþ: Sihirli kelime " + mostLikelyThingHeard + "deðil";
		// }
		if (!found) {
			AlertDialog a =
					new AlertDialog.Builder(this).setTitle("Sonuçlar")
