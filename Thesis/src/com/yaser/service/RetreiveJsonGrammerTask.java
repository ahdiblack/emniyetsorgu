...
public class RetreiveJsonGrammerTask extends AsyncTask<String, Void, Person> {

	private GrammerMenu sorguContext;

	public RetreiveJsonGrammerTask() {
	}

	public RetreiveJsonGrammerTask(GrammerMenu kimlikSorgu) {
