...
public class RetreivePlakaJsonTask extends AsyncTask<String, Void, Plaka> {

	private PlakaSorgu sorguContext;

	public RetreivePlakaJsonTask() {
	}

	public RetreivePlakaJsonTask(PlakaSorgu plakaSorgu) {
