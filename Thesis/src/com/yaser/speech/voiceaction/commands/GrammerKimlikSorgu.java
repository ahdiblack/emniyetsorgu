...
public class GrammerKimlikSorgu implements VoiceActionCommand
{
    private VoiceActionExecutor executor;
    private Context context;
    private WordMatcher match;

    public GrammerKimlikSorgu(Context context, VoiceActionExecutor executor)
    {
...
//                RetreiveJsonTask task = new RetreiveJsonTask(GrammerKimlikSorgu.this);
