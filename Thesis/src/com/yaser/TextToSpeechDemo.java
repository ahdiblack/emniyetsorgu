...
import com.yaser.speech.tts.TextToSpeechUtils;
    ...
    private void hookButtons()
    {
        ...
        speak.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                for (int i = 0; i < 5; i++) {
					tts.speak("Sayý = " + i, TextToSpeech.QUEUE_ADD,TextToSpeechUtils.makeParamsWith("EXECUTE_AFTER_SPEAK"));
				}
                AlertDialog a =
                        new AlertDialog.Builder(TextToSpeechDemo.this).setTitle("Error")
                                .setMessage("Unable to create text to speech").create();
                a.show();
//                playScript();
            }
        });
    ...
    private void playScript()
    {
        ...
        tts.addEarcon(EARCON_NAME, "com.yaser.thesis", R.raw.tone);

        // add prerecorded speech
        final String CLOSING = "[Teþekkürler]";
        tts.addSpeech(CLOSING, "com.yaser.thesis",
        ...
        tts.speak("Lütfen 11 haneli TC Kimlik Numarasýný Söyleyin",
